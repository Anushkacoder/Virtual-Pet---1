...
function setup(){
  ...
  pet = createInput("              WHAT WOULD YOUR PET'S NAME BE ?  (Decide after choosing your pet & press ENTER)");
  pet.position(200,5);
  pet.size(620,20);
  pet.style('background','black');
  pet.style('color','white');

  // grant = createButton("Grant this name to my pet");
  // grant.position(width/2-50,30);
  // grant.style('background','indigo');
